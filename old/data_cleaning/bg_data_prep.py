...
Purpose: Extracts citizenship data from Census special tabulation 
This code does not give total population or voting age population broken
down by race. 
